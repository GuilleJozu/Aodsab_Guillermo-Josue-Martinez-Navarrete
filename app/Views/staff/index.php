...
<div>
    <a href="/staff/create" class="button is-link">Agregar</a>
</div>
<br>
...
<!-- IMPLEMENTACIÓN DE DATATABLES -->
	...
	<table id="example" class="table is-bordered is-striped is-narrow is-hoverable is-fullwidth">
		...
		<?php foreach ($staffs as $staff): ?>
            ...
            <tr>
                <td><?= esc($staff['nombre']) ?></td>
                <td><?= esc($staff['apellidos']) ?></td>
                <td><?= esc($staff['funcion']) ?></td>
                <td><?= esc($staff['descripcionFuncion']) ?></td>
                <td><?= esc($staff['fechaIngreso']) ?></td>
                <td><?= esc($staff['salario']) ?></td>
                <td><?= esc($staff['activo']) ?></td>
